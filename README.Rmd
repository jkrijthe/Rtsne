...
```
[![CRAN version](http://www.r-pkg.org/badges/version/Rtsne)](http://cran.rstudio.com/web/packages/Rtsne/index.html)
...
[![CRAN mirror downloads](http://cranlogs.r-pkg.org/badges/Rtsne)](http://cran.rstudio.com/web/packages/Rtsne/index.html)
